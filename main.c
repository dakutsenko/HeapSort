 ...
 *
 * Пирамидальная сортировка может рассматриваться
 * как улучшенная сортировка выбором (selection sort).
 *
 * Достоинства алгоритма:
 * 1. В худшем, среднем и лучшем случаях работает за O(n log n) операций
...
void fix_down(Item a[], int k, int n) {
	 ...
	 * с бóльшим из его двух потомков
...
/* Выполнить пирамидальную сортировку с l-го по r-й элемент массива a */
